...
DNS_SUBDOMAIN_LABELS = ['actual', 'audiobookshelf', 'authentik', 'garage', 'wealthfolio', 's3', 'jobops', 'komodo', 'openclaw', 'openwebui', 'uptime', 'vaultwarden', 'mealie', 'mediaflow', 'paperless', 'vikunja', 'wallos', 'aiometadata', 'poster-cache', 'decypharr', 'sonarr', 'radarr', 'plex', 'live-sports']
