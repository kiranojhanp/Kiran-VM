...
DNS_SUBDOMAIN_LABELS = ['actual', 'audiobookshelf', 'authentik', 'garage', 'wealthfolio', 's3', 'jobops', 'komodo', 'openclaw', 'openwebui', 'uptime', 'vaultwarden', 'mealie', 'paperless', 'vikunja', 'wallos', 'music', 'lidarr']
