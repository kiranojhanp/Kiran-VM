...
Use the same flow for every stack (`actual`, `audiobookshelf`, `garage`, `ghostfolio`, `jobops`, `mealie`, `openwebui`, `paperlessngx`, `uptime-kuma`, `vikunja`, `vaultwarden`, `wallos`):
...
- [Ghostfolio](ghostfolio/README.md)
