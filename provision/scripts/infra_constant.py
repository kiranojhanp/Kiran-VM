...
def load_constants_module():
    ...
    cache_path = importlib.util.cache_from_source(str(constants_path))

    # constants.py is generated by Task, sometimes multiple times within the same
    # second. Drop stale bytecode to guarantee fresh reads on each invocation.
